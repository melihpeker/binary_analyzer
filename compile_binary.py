...
def compile_binary(path, name, output_path, options):
    ...
    # command = "gcc -I dataset/polybench-c-3.2/utilities -I dataset/polybench-c-3.2/linear-algebra/kernels/atax dataset/polybench-c-3.2/utilities/polybench.c dataset/polybench-c-3.2/linear-algebra/kernels/atax/atax.c -DPOLYBENCH_TIME -o atax_base"
    # os.system(command)
    # command = "gcc -v"
    env = os.environ.copy()
    getVersion = subprocess.Popen(command, shell=True, stdout=subprocess.PIPE, env=env).stdout
